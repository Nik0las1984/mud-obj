...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ObjectsListValue'
        db.delete_table(u'objects_objectslistvalue')


    def backwards(self, orm):
        # Adding model 'ObjectsListValue'
        db.create_table(u'objects_objectslistvalue', (
            ('obj', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['objects.Object'])),
            ('data', self.gf('picklefield.fields.PickledObjectField')()),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('olist', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['objects.ObjectsList'], null=True, blank=True)),
        ))
        db.send_create_signal(u'objects', ['ObjectsListValue'])
    ...
    models = {
        ...
        u'objects.object': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 6, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 6, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'objects.objectslist': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 6, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
