...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Recipe'
        db.create_table(u'objects_recipe', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal(u'objects', ['Recipe'])

        # Adding field 'Object.recipe'
        db.add_column(u'objects_object', 'recipe',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['objects.Recipe'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Recipe'
        db.delete_table(u'objects_recipe')

        # Deleting field 'Object.recipe'
        db.delete_column(u'objects_object', 'recipe_id')
    ...
    models = {
        ...
        u'objects.object': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 31, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 31, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'objects.objectslist': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 31, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
