...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Object.take_left'
        db.add_column(u'objects_object', 'take_left',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)

        # Adding field 'Object.take_right'
        db.add_column(u'objects_object', 'take_right',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)

        # Adding field 'Object.take_both'
        db.add_column(u'objects_object', 'take_both',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Object.take_left'
        db.delete_column(u'objects_object', 'take_left')

        # Deleting field 'Object.take_right'
        db.delete_column(u'objects_object', 'take_right')

        # Deleting field 'Object.take_both'
        db.delete_column(u'objects_object', 'take_both')
