...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Object.last_modified'
        db.add_column(u'objects_object', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 25, 0, 0), auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Object.last_modified'
        db.delete_column(u'objects_object', 'last_modified')
    ...
    models = {
        ...
        u'objects.object': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 25, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 25, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'objects.objectslist': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 25, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'objects.objectslistvalue': {
            ...
            'olist': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['objects.ObjectsList']", 'null': 'True', 'blank': 'True'})
        },
