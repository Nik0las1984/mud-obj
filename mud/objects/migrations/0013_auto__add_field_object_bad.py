...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Object.bad'
        db.add_column('objects_object', 'bad',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Object.bad'
        db.delete_column('objects_object', 'bad')
    ...
    models = {
        ...
        'objects.object': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 20, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
