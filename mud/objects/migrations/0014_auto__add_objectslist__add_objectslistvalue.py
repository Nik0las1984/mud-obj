...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ObjectsList'
        db.create_table(u'objects_objectslist', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')()),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 10, 25, 0, 0), auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'objects', ['ObjectsList'])
    ...
    def backwards(self, orm):
        # Deleting model 'ObjectsList'
        db.delete_table(u'objects_objectslist')
