...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Object.added'
        db.add_column('objects_object', 'added',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 27, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Object.added'
        db.delete_column('objects_object', 'added')
