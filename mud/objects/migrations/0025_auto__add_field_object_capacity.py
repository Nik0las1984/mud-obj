...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Object.capacity'
        db.add_column(u'objects_object', 'capacity',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Object.capacity'
        db.delete_column(u'objects_object', 'capacity')
    ...
    models = {
        ...
        u'objects.object': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 16, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 16, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            ...
            'zones': ('django.db.models.fields.related.ManyToManyField', [], {'default': 'None', 'to': u"orm['zones.Zone']", 'null': 'True', 'symmetrical': 'False', 'blank': 'True'})
        },
