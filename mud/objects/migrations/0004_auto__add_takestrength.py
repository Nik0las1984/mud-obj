...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TakeStrength'
        db.create_table(u'objects_takestrength', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('take', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['objects.Take'])),
            ('value', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'objects', ['TakeStrength'])


    def backwards(self, orm):
        # Deleting model 'TakeStrength'
        db.delete_table(u'objects_takestrength')
