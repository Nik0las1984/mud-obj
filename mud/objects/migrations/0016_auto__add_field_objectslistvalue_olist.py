...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ObjectsListValue.olist'
        db.add_column(u'objects_objectslistvalue', 'olist',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['objects.ObjectsList'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ObjectsListValue.olist'
        db.delete_column(u'objects_objectslistvalue', 'olist_id')
