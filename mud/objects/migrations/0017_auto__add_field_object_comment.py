...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Object.comment'
        db.add_column(u'objects_object', 'comment',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Object.comment'
        db.delete_column(u'objects_object', 'comment')
    ...
    models = {
        ...
        u'objects.object': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 11, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'objects.objectslist': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 11, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
