...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Object', fields ['name']
        db.delete_unique(u'objects_object', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'Object', fields ['name']
        db.create_unique(u'objects_object', ['name'])
