...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field objs on 'ObjectsList'
        db.create_table(u'objects_objectslist_objs', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('objectslist', models.ForeignKey(orm[u'objects.objectslist'], null=False)),
            ('object', models.ForeignKey(orm[u'objects.object'], null=False))
        ))
        db.create_unique(u'objects_objectslist_objs', ['objectslist_id', 'object_id'])


    def backwards(self, orm):
        # Removing M2M table for field objs on 'ObjectsList'
        db.delete_table('objects_objectslist_objs')
