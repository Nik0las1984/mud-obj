...
wechoaround %actor% Кто-то спустился в подвал.
end
~
#14603
УдалениеШмота~
...
wait 1s
if %random.2% == 1
  oecho _Древние &Kруны &nскладываются в &yслова&n - &WНичего личного&n - только &Rбизнес&n.
else
  oecho _&KТьма&n опустилась, Вы &gпочувствовали&n как &KЧто-то&n промелькнуло за Вашей спиной, чувство &Yзагнанного &gзверя&n пробудилось в душе.
end
~
#14608
Вход в вольер~
...
~
wait 2
%send% %actor% Набравшись мужества, Вы открыли решетку и вошли в вольер.
~
#14609
Кормим медведя~
0 j 100
~
wait 3
%echo% %self.iname% разорвал %object.vname% на кусочки.
mjunk all
~
#14610
КрадемсяНазад~
