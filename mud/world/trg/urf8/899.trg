...
mechoaround %actor% _%actor.name% расплыл%actor.u% в улыбке, глядя на повара.
wait 1s
say Чего лыбишься?
wait 2s
...
if %exist.mob(89902)%
  mload obj 89918
  mecho Темная сторона души легата испустила душераздирающий крик и отправилась прямиком в АД.
  mecho На земле осталась лишь книжица в темном переплете.
else
  mecho Темная сторона души легата испустила душераздирающий крик и отправилась прямиком в АД.
end
~
...
0 f 100
~
%echo% Сильный удар - и голова магистра отлетела в сторону!
mload obj 89928
~
#89920
...
~
#89941
Убили командира охраны магистра~
0 f 100
~
if (%random.100% < 11)
  mload obj 89944
...
~
#89942
Командир охраны агрит взломщика~
0 z 100
~
msend %victim% Командир охраны заметил вашу попытку обокрасть магистра!
mechoaround %victim% Командир охраны заметил попытку %victim.rname% обокрасть магистра!
крича Тревога! Тревога!!! В лагере лазутчики!
mkill %victim%
~
#89943
Ломают или открывают сундук магистра~
1 ps 100
~
if (%actor.vnum% != -1)
  return 0
