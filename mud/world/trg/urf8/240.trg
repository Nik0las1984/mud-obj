...
switch %i%
  ...
  break
  case 2
    mecho Юродивый сложил губы трубочкой и надул особо крупный пузырь из слюны.
  break
  case 3
...
if (%self.haveobj(60060)% && %self.haveobj(60061)%)
  ...
  брос все
  mat 27031 mecho Кто-то появился здесь в клубах сизого дыма.
  mteleport all 27031
end
~
#24009
...
wait 1
mat 8508 mecho Кто-то сошел с парома, причалившего к берегу.
mteleport all 8508
end
~
#24011
...
eval char %actor%
wait 1
msend %char% Ворожея сказала тебе:
msend %char% - Да защитит тебя Белобог от всякого зла, %char.name%!
msend %char% - Вижу что не просто так ты сюда заш%char.y%! Могу тебе помочь!
msend %char% - Коли ты дашь мне немного кун для жертвы Яриле
msend %char% - Я помогу тебе мигом добраться до нужного русского города.
~
$~
