...
0 f 100
~
msend %actor.name% Сокол в последний раз взмахнул крыльями и умер.
...
wsend %actor%  Вы начали карабкаться на дерево.
...
wsend %actor%  Вы вылезли из избушки.
...
г Как не искали его так и не нашли...
плак
wait 1s
...
msend %actor% Старик дал Вам горку монет.
mechoaround %actor% Старик дал горку монет %actor.dname%.
%actor.gold(+1300)%
~
#13215
Репоп~
