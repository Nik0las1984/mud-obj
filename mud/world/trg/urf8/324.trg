...
if (%actor.religion% == 1)
  ...
  say Извините, но язычникам не место в нашей обители.
  *wait 1s
...
if (%self.haveobj(60067)% && %self.haveobj(60061)%)
  ...
  drop all
  mat 30213 mecho Кто-то появился здесь в клубах сизого дыма.
  mteleport all 30213
end
if (%self.haveobj(60067)% && %self.haveobj(60060)%)
  ...
  mecho Ворожея что-то пошептала над ингредиентами и поднесла их к идолу.
  drop all
  mat 76083 mecho Кто-то появился здесь в клубах сизого дыма.
  mteleport all 76083
end   
if (%self.haveobj(60068)% && %self.haveobj(60060)%)
  ...
  mecho Ворожея что-то пошептала над ингредиентами и поднесла их к идолу.
  drop all
  mat 75066 mecho Кто-то появился здесь в клубах сизого дыма.
  mteleport all 75066
end
~
#32407
