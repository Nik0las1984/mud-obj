...
дум
wait 1
say К величайшему сожалению, во время битвы с Вами Черный Дайме вызвал
...
elseif (%random.1000% >= 500)
  ...
  mecho Ямабуси достал из кармана двадцатигранный кубик и кинул.
  wait 5
  mecho Кубик упал на землю и выпало 10.
  wait 5
  дум
  say Как гласит наша религия, это означает, что сегодня в твоей жизни не будет перемен...
end
wait 5
хих
wait 5
...
wait 7
if %world.curobjs(413)% < 1
  mload obj 413
end
дать трактат .%actor.name%
брос все   
