...
~
wait 10
wecho _Створки городских ворот злобно заскрипели и...
...
wechoaround %actor% Через несколько минут %actor.iname% приш%actor.y% в себя
...
if (%self.haveobj(60067)% && %self.haveobj(60066)%)
  ...
  брос все
  mat 32419 mecho Кто-то появился здесь в клубах сизого дыма.
  mteleport all 32419
end
...
if (%self.haveobj(60068)% && %self.haveobj(60060)%)
  ...
  mecho Ворожея что-то пошептала над ингредиентами и поднесла их к идолу.
  брос все
  mat 18206 mecho Кто-то появился здесь в клубах сизого дыма.
  mteleport all 18206
end
~
#63017
