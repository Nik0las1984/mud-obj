...
mecho Вы очнулись в какой-то яме, но тут ворон перед Вами заговорил человеческим голосом
...
wait 1s
г Здраве буде
г Коли не с оружием ко мне в хоромы, а с добрым помыслом
...
if (%actor.sex% == 1)
  ...
  г Ой спасибо, красна девица, но ты даже не знаешь, что я от тебя хочу!
end
...
0 d 1
расскажи говори согласен согласна готов готова~
detach 47722 %self.id%
wait 1
...
if (%actor.sex% == 1)
  ...
  г Помоги нам, красна девица, убей ворона, может узнаешь куда унес он мою сестрицу
end
calcuid ravenroom 47732 room
...
if (%world.curobjs(47732)% < 6) && (%random.5% == 1)
  wload obj 47732
  %echo% Перо ворона плавно опустилось на землю.
end
~
#47727
телепорт~
...
wteleport all 47738
halt
*С прошлой конструкцией бывали непонятные недотелепорты)
eval gopa %actor.pc%
foreach i %gopa%
  wteleport %i% 47738
done
...
wait 1
г Вот и славно
г Ступай, да пребудет с тобой Господь
set quest2477 %actor%
global quest2477
