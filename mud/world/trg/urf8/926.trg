  ...
  *дух чернокнижника,  если живы сами чернокнижники
  case 1
    if %world.curmobs(92601)% || %world.curmobs(92606)% 
      %echo% _Серый портал открылся над Вами!
      %echo% Дух чернокнижника прилетел сверху! 
      %load% mob 92630
      wait 10t
    end
  break       
  ...
  case 2
    case 3
      if %world.curmobs(92611)% >0
        %echo% Лазурная пентаграмма появилась в воздухе.
        %echo% Ахмет появился из пентаграммы!
        %echo% Пентаграмма медленно растаяла.
        %teleport% ахмет_моб %self.vnum%
        wait 10t
      end
    break                    
    *Огненный воин если живы колдуны
    default
      if %world.curmobs(92608)% || %world.curmobs(92610)% 
        %echo% Лазурная пентаграмма появилась в воздухе.
        %echo% Огненный воин появился из пентаграммы!
        %echo% Пентаграмма медленно растаяла.
        %load% mob 92627
        wait 10t
      end
...
wait 1s
say Залетал я как-то соколом в ирий-рай.
