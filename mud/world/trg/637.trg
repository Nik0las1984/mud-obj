...
switch %random.2%
  case 1
    mecho _Старый воин достал из кармана кольцо.
    wait 1s
    mload obj 63739
    дать секи %actor.iname%
    г Вот, нашел кольцо мне оно нафиг не нужно, может тебе пригодится.
  break
  default 
...
mat 63720 mecho Кто-то появился здесь в клубах сизого дыма.
mteleport all 63720
calcuid delete_trig 63701 mob
...
wait 4s
mecho _Призрак взмахнул рукой и Вас перенесло неведомо куда.
mat 63737 mecho Кто-то появился здесь в клубах сизого дыма.
mteleport all 63737
...
oechoaround %actor.iname% _%actor.iname% подпрыгнул%actor.a% и сбил%actor.a% прекрасный плод с ветки.
...
if (%object.vnum% == 63716) 
  ...
  mecho _-А ваши кости сгниют - и никто не узнает, где вы смерть нашли!
  хохот
  mecho _Призрак взмахнул рукой и Вас перенесло неведомо куда!
  mat 63705 mecho Кто-то появился здесь в клубах сизого дыма.
  mteleport all 63705
  wait 1
  calcuid delete_trig 63701 mob
  mload mob 63712
...
oechoaround %actor%  %actor.iname% швырнул%actor.g% здоровую каменюку в пентаграмму.
